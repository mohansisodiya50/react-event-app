		...
		return (
			<Grid>
				...
				<Grid.Column width={6}>
					...
					{this.state.isOpen && <EventForm updateEvent={this.handleUpdateEvent} onCancel={this.handleFormCancel} createEvent={this.handleCreateEvent} selectedEvent={this.state.selectedEvent} />}
				</Grid.Column>
			</Grid>
		)
	}
